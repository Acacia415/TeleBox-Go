...
var catalog = []Spec{
	...
	{Name: "music_bot", Package: modulePath + "/plugins/musicbot", Constructor: "New", SourceDir: "plugins/musicbot"},
	...
	{Name: "speedtest", Package: modulePath + "/plugins/speedtest", Constructor: "New", SourceDir: "plugins/speedtest"},
